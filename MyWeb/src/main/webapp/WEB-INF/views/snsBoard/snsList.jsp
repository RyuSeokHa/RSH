...
<body>
	...
	<script>
		//등록하기 버튼
		$(document).ready(function() { //페이지가 로드된 다음에 실행된다.
			...
			function regist() {
				...
				file = file.slice( file.indexOf(".") + 1 ).toLowerCase(); //toLowerCase 소문자로 변환
			...
			function getList(reset) {
				//1. getJSON을 통해서 DB에 저장되어 있는 모든 값을 JSON형태로 전달받음
